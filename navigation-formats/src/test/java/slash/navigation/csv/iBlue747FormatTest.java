...
public class iBlue747FormatTest {
    ...
    public void testIsValidHeader() {
        assertTrue(format.isValidHeader(asList("LONGITUDE", "E/W", "LATITUDE", "N/S")));
        assertFalse(format.isValidHeader(asList("Longitude", "Latitude", "Comment")));
    }
    ...
    public void testIsValidPosition() {
        ...
        properties.put("E/W", "W");
        properties.put("LATITUDE", "2.0");
        properties.put("N/S", "N");
